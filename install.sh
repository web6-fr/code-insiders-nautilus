...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/code-nautilus.py https://raw.githubusercontent.com/web6-fr/code-insiders-nautilus/master/code-nautilus.py
